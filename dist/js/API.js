...
exports.addTodo = (formData) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const todo = {
            name: formData.name,
...
exports.updateTodo = (todo) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const todoUpdate = {
            status: true,
        };
...
exports.deleteTodo = (_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
